...
if __name__ == '__main__':
    ...
    synonyms_trainer.train_phrases(args.file_or_folder_with_dataset)
    synonyms_trainer.train_models(args.file_or_folder_with_dataset, all_models=args.all_models, google_model=args.google_model,
